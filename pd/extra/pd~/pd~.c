...
static void pd_tilde_dostart(t_pd_tilde *x, const char *pddir, const char *schedlibdir,
...
{       
    ...
    c = class_new("pd~", (method)pd_tilde_new, (method)pd_tilde_free, sizeof(t_pd_tilde), (method)0L, A_GIMME, 0);

    class_addmethod(c, (method)pd_tilde_dsp, "dsp64", A_CANT, 0);
