...
{
    t_audiosettings a;
    sys_get_audio_settings(&a);
    return a.a_blocksize;
}
...
void sys_set_audio_settings(t_audiosettings *a)
{
    ...
    gui_vmess("set_audioapi", "i",  audio_nextsettings.a_api);
}
...
void sys_do_reopen_audio(void)
{
    ...
    gui_vmess("set_audioapi", "i", sys_audioapiopened);
}
...
void glob_audio_properties(t_pd *dummy, t_floatarg flongform)
{
    ...
    gui_i(as.a_indevvec[0]); gui_i(as.a_indevvec[1]);
    gui_i(as.a_indevvec[2]); gui_i(as.a_indevvec[3]);
    gui_end_array();

    gui_start_array(); // audio input channels
    gui_i(as.a_chindevvec[0]); gui_i(as.a_chindevvec[1]);
    gui_i(as.a_chindevvec[2]); gui_i(as.a_chindevvec[3]);
    gui_end_array();

    gui_start_array(); // audio output devices
    gui_i(as.a_outdevvec[0]); gui_i(as.a_outdevvec[1]);
    gui_i(as.a_outdevvec[2]); gui_i(as.a_outdevvec[3]);
    gui_end_array();

    gui_start_array(); // audio output channels
    gui_i(as.a_choutdevvec[0]); gui_i(as.a_choutdevvec[1]);
    gui_i(as.a_choutdevvec[2]); gui_i(as.a_choutdevvec[3]);
    gui_end_array();

    gui_start_array();
    gui_s("rate");        gui_i(as.a_srate);
    gui_s("advance");     gui_i(as.a_advance);
