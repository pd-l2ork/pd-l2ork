// ===================================================================
// Wiimote external for Puredata by Ivica Ico Bukvic and William Furgerson
...
//  v2.0.0 Changelog:
//  2024-04-25 DISIS (William Furgerson <williamfurgerson@vt.edu)
//  * Replaced CWIID with the more modern xwiimote library
//  * Rewrote disis_wiimote using new library
